# Autogenerated wrapper script for mdbtools_jll for x86_64-apple-darwin14
...
const libmdb_splitpath = ["lib", "libmdb.2.dylib"]
...
const libmdb = "@rpath/libmdb.2.dylib"


# Relative path to `libmdbsql`
const libmdbsql_splitpath = ["lib", "libmdbsql.2.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libmdbsql = "@rpath/libmdbsql.2.dylib"


# Relative path to `mbd_ver`
const mbd_ver_splitpath = ["bin", "mdb-ver"]
...
const mdb_array_splitpath = ["bin", "mdb-array"]
...
const mdb_count_splitpath = ["bin", "mdb-count"]
...
const mdb_export_splitpath = ["bin", "mdb-export"]
...
const mdb_header_splitpath = ["bin", "mdb-header"]
...
const mdb_hexdump_splitpath = ["bin", "mdb-hexdump"]
...
const mdb_parsecsv_splitpath = ["bin", "mdb-parsecsv"]
...
const mdb_prop_splitpath = ["bin", "mdb-prop"]
...
const mdb_schema_splitpath = ["bin", "mdb-schema"]
...
const mdb_sql_splitpath = ["bin", "mdb-sql"]
...
const mdb_tables_splitpath = ["bin", "mdb-tables"]
