...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import mdbtools_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("07583aeb-fc39-51f3-a266-a2fa5ce88e58"))
platforms = [Pkg.Artifacts.unpack_platform(e, "mdbtools", artifacts_toml) for e in artifacts["mdbtools"]]
...
if best_platform === nothing
    @debug("Unable to load mdbtools; unsupported platform $(triplet(platform_key_abi()))")
else
